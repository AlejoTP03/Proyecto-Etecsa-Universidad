 ...
 * @author Lino
 */
public class LlamadaNacionalInterprovincial extends javax.swing.JFrame {

    /**
     * Creates new form LlamadaNacionalInterprovincial
     */
    public LlamadaNacionalInterprovincial() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LlamadaNacionalInterprovincial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LlamadaNacionalInterprovincial().setVisible(true);
            }
        });
    }
